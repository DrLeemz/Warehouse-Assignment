 ...
 */
	...
	public void readFoodItem(String line)
	{
      ...
      FoodItem food = new FoodItem(name,upc,shelfLife);
      foodItems.put(upc,food);
	}
	...
	public void readReceive(String line)
	{
      ...
      FoodItem food2Add = foodItems.get(upc);//Gets the foodItem from our hashmap of all available FoodItems.      
      
      GregorianCalendar expires = food2Add.getExpirationDate(calendar);//FoodItem method. Calculates when food spoils.
         
      Inventory<FoodItem> warehouseInventory = warehouses.get(warehouse);//Gets the inventory of the warehouse we are working with.  
      warehouseInventory.addItem(food2Add, expires, quantity);//Add what will become a DatedItem.
	}
	...
	public void readRequest(String line)
	{
      ...
      Inventory<FoodItem> warehouseInventory = warehouses.get(warehouse);    
	}
